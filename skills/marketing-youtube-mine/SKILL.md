...
marketing-reddit's NLP, so both miners produce the same shapes and quality bar.
...
Same `questions[]` / `clusters_unanswered` fields as marketing-reddit — merge the
