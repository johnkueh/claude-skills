...
Proven across myapp and journeys.im. Pattern B from Mobbin research — the most universal onboarding pattern (Kitchen Stories, Vrbo, IHG, CREME all ship it).
...
```tsx
// See myapp or journeys.im implementations for the full component.
...
- **myapp** — `app/src/app/onboarding/index.tsx` + `app/src/components/onboarding/`
